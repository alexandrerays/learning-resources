...
void contaPreposicoes(char *s, int *ptPreposicoes,FILE *ft,char *texto) //usar strtok
{
...
void contaMaisquedez(char *s, int *ptMaisquedez, int *ptPalavra,FILE *ft,char *texto)
{
...
void menu(char *tarefas, char *s, int *ptPalavra, int *ptEspacos, int *ptTab, int *ptPreposicoes, int *ptMaisquedez,FILE *ft, char *texto)
{
    ...
    if(tarefas[1]=='1')
    {
        contaPreposicoes(s,ptPreposicoes,ft,texto);
    }
    if(tarefas[2]=='1')
    {
    ...
    {
        contaPalavras(s,ptPalavra,ft,texto);
        contaMaisquedez(s,ptMaisquedez,ptPalavra,ft,texto);
    }
}
